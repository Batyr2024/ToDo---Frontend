(function getElement() {
  ...
  return arrayTask, taskInput, addTaskButton, taskList, taskDeleted, checkboxSelectAll, idGlobalArray, spanAll, spanActive, spanCompleted;

function render(taskList, arrayTask) {
  taskList.innerHTML = '';
