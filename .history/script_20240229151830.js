...
const taskListInput = document.taskList.querySelector('#taskListInput');
...
function changeTasks(event) {
  ...
  arrayTask.forEach((element) => {
    ...
    <li id=${idCheckbox}>
    <input class="checkbox"  id=${idCheckbox} type ="checkbox">
    <input id=taskListInput type="text" value=${taskText}>
    <span id=${idCheckbox} class="delete">X</span>
    </li>
        `;
    } else {
...
function addChangeTasks() {
  const taskListInput = taskList.querySelector('#taskListInput');
