...
function render() {
  ...
  <span id=${idCheckbox} class="delete">X</span>
    ...
    spanActive.textContent = String(arrayActive.length + 1);
    spanCompleted.textContent = String(arrayCompleted.length + 1);
    spanAll.textContent = String((arrayActive.length + 1) + (arrayCompleted.length + 1));
  });
}
function showActive() {
