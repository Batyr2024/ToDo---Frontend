...
const spanAll = document.getElementById('spanAll'); const all = 0;
const spanActive = document.getElementById('spanActive'); const active = 0;
const spanCompleted = document.getElementById('spanCompleted'); const completed = 0;
function render() {
  taskList.innerHTML = '';
...
function handleAddTask() {
  ...
  render();
  taskInput.value = '';
  spanAll.textContent = String((all + 1));
  spanActive.textContent = String((active + 1));
  spanCompleted.textContent = String(completed);
  console.log();
}
